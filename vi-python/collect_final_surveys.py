...
if __name__ == '__main__':
    ...
    ideal_values = []
    measurement_values = []
    module_files = glob.glob(sys.argv[1]+r'\*.txt')
    ...
    np.savetxt(sys.argv[2] + 'IdealsTest.csv', data_ideals, fmt='%.6f', delimiter=',')
    np.savetxt(sys.argv[2] + 'SurveyTest.csv', data_measurements, fmt='%.6f', delimiter=',')
